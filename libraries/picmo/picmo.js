...
class $e extends Le {
  ...
  getRecents(e) {
    try {var _this$storage$getItem;
      return JSON.parse((_this$storage$getItem = this.storage.getItem(G)) !== null && _this$storage$getItem !== void 0 ? _this$storage$getItem : "[]").slice(0, e);
    } catch {
      return [];
    }
  }
...
class $ extends c {
  ...
  setFocusedView(e, t) {
    ...
    if (typeof e == "string") {
      ...
      this.grid.setFocusedIndex(s, !1), setTimeout(() => {var _ref;
        var n, l, d;
        ...
        a.scrollTop -= (_ref = r == null ? void 0 : r.offsetHeight) !== null && _ref !== void 0 ? _ref : 0;
      });
    } else
...
class Yt extends c {
  ...
  focusPreviousCategory(e) {
    this.selectedCategory > 0 && this.focusCategory(this.selectedCategory - 1, { row: "last", offset: e !== null && e !== void 0 ? e : this.options.emojisPerRow });
  }
  focusNextCategory(e) {
    this.selectedCategory < this.categories.length - 1 && this.focusCategory(this.selectedCategory + 1, { row: "first", offset: e !== null && e !== void 0 ? e : 0 });
  }
  /**
...
function fo() {var _ref2;
  const o = yo.find(e => vo(e.emoji));
  return (_ref2 = o == null ? void 0 : o.version) !== null && _ref2 !== void 0 ? _ref2 : 1;
}
function vo(o) {
